...
class FillPermissionsForCategoryProduct extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategoryProduct constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.category-product.show',
            'admin.category-product.edit',
            'admin.category-product.delete',
            'admin.category-product.bulk-delete',
        ]);
