          ...
          <div class="py-2">
            <ul class="flex flex-row gap-2">
              <li>
                <a
                  href="/"
                  class="no-underline hover:underline font-semibold text-sm leading-5 text-black"
                  >Home</a
                >
              </li>
              <li>/</li>
              ...
              <li>
                <a
                  href="#"
                  class="no-underline hover:underline font-semibold text-sm leading-5 text-[#0064D2]"
                  >Minimal Zebra Logo</a
                >
              </li>
            </ul>
          </div>
                                    ...
                                    <div class=" px-20 font-ProductSans">
                                        <div class="text-primary text-2xl font-extrabold col-span-2 tracking-wide  mb-4">
                                            ...
                                            <div class="mt-5 text-sm font-[400] text-info">
                                                Des projets suivis et créés de A à Z dans des délais raccourcis par rapport à une agence de communication.
                                                Des tarifs plus attractifs et totalement maîtrisés et sans surprises qu’en agences de com’ ou de publicité.
