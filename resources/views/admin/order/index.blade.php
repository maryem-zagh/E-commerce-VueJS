                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'name'">{{ trans('admin.order.columns.name') }}</th>
                                        <th is='sortable' :column="'phone'">{{ trans('admin.order.columns.phone') }}</th>
                                        <th is='sortable' :column="'email'">{{ trans('admin.order.columns.email') }}</th>
                                        <th is='sortable' :column="'adress'">{{ trans('admin.order.columns.adress') }}</th>
                                        <th is='sortable' :column="'city'">{{ trans('admin.order.columns.city') }}</th>
                                        <th is='sortable' :column="'country'">{{ trans('admin.order.columns.country') }}</th>
                                        <th is='sortable' :column="'is_gift'">{{ trans('admin.order.columns.is_gift') }}</th>
                                        <th is='sortable' :column="'message'">{{ trans('admin.order.columns.message') }}</th>
